...
**          
** $Source: /mit/games/src/vax/xtank1.2/Src/RCS/Buddy.h,v $
** $Author: dschmidt $
** $Revision: 1.4 $
**
** $Log:	Buddy.h,v $
...
#define Buddy_wall(bi,side,x,y) \
  map_wall(((bi)->map),(side),(x),(y))
#define Buddy_spin_discs(x) \
  (spin_discs(x), bi->spin = (x))

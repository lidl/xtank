...
Weapon_stat weapon_stat[VMAX_WEAPONS] = {
  { "Light Machine Gun",  2, 360, 300, 3, 17,  20,  200, 22,  0, 0,  1, 1000},
...
Armor_stat armor_stat[VMAX_ARMORS] = {
  {"Steel",          0,  8, 3, 10},
  {"Kevlar",         0,  3, 3, 20},
...
Engine_stat engine_stat[VMAX_ENGINES] = {
...
Body_stat body_stat[VMAX_BODIES] = {
...
Suspension_stat suspension_stat[VMAX_SUSPENSIONS] = {
  {"Light",  -1,   100},
  {"Normal",  0,   200},
  {"Heavy",   1,   400},
  {"Active",  2,  1000}
...
Tread_stat tread_stat[VMAX_TREADS] = {
  {"Smooth",       .70,   100},
  {"Normal",       .80,   200},
  {"Chained",      .90,   400},
  {"Spiked",      1.00,  1000}
...
Bumper_stat bumper_stat[VMAX_BUMPERS] = {
  {"None",      0.0,        0},
  {"Normal",    0.07,     200},
  {"Rubber",    0.15,     400},
  {"Retro",     0.25,    1000}
...
Special_stat special_stat[VMAX_SPECIALS] = {
  {"Console",  250},
  {"Mapper",   500},
  {"Radar",   1000}
};

	...
	if (fgrid_x > tgrid_x)
		if (fgrid_y > tgrid_y)
		{
			...
			while (tgrid_x != fgrid_x || tgrid_y != fgrid_y)
			{
				...
				{
					if (box[tgrid_x][tgrid_y + 1].flags & NORTH_WALL)
						return TRUE;
					tgrid_y++;
				...
				{
					if (box[tgrid_x + 1][tgrid_y].flags & WEST_WALL)
						return TRUE;
					tgrid_x++;
		...
		else if (fgrid_y < tgrid_y)
		{
			...
			while (tgrid_x != fgrid_x || tgrid_y != fgrid_y)
			{
				if (lattice_dy * dx > dy * lattice_dx)
				{
					if (box[tgrid_x][tgrid_y].flags & NORTH_WALL)
						return TRUE;
					tgrid_y--;
					lattice_dy -= BOX_HEIGHT;
				}
		...
		if (fgrid_y > tgrid_y)
		{
			...
			while (tgrid_x != fgrid_x || tgrid_y != fgrid_y)
			{
				...
				{
					if (box[tgrid_x][tgrid_y].flags & WEST_WALL)
						return TRUE;
					tgrid_x--;
					lattice_dx -= BOX_WIDTH;
				}

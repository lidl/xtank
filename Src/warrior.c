...
warrior_main()
{
  ...
  while(1){
    ...
    else done();   /* we've already been here this frame, so end */
...
warrior_try_to_go(all, angl, speed)
     Everything *all;
     float angl,speed;
{

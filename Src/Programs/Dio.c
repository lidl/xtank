...
/*
$Author: lidl $
$Id: Dio.c,v 2.6 1992/08/19 05:18:46 lidl Exp $

$Log: Dio.c,v $
 * Revision 2.6  1992/08/19  05:18:46  lidl
 * changed to use FLOAT, instead of float
 *
 * Revision 2.5  1992/08/19  05:13:27  lidl
 * changed sqrt to SQRT
 *
 * Revision 2.4  1991/09/29  15:40:22  lidl
 * changed all occurances of atan2 to ATAN2, so it uses the correct macro
 *
 * Revision 2.3  1991/02/10  13:49:56  rpotter
 * bug fixes, display tweaks, non-restart fixes, header reorg.
 *
 * Revision 2.2  91/01/20  09:57:06  rpotter
 * complete rewrite of vehicle death, other tweaks
 * 
 * Revision 2.1  91/01/17  07:10:35  rpotter
 * lint warnings and a fix to update_vector()
 * 
 * Revision 2.0  91/01/17  02:08:49  rpotter
 * small changes
 * 
 * Revision 1.2  90/12/30  00:11:15  aahz
 * removed warning generated by gcc.
 * 
 * Revision 1.1  90/12/29  21:01:40  aahz
 * Initial revision
 * 
*/

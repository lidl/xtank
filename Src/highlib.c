...
Location *start, *finish;
{
	...
	/* * This does not do the "obvious" thing.  It does the fast thing. * It
	   compares the slopes of lines (from the destination to gridpoints *
	   along the path) to the line of the path.  From these comparisons, * it
	   determines which gridpoint to walk to next.  It does NOT walk * from
	   box to box, but from gridpoint to gridpoint. */

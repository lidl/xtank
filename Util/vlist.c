...
Date: Wed, 25 Sep 91 12:21:47 EST
To: xtank@eng.umd.edu
Subject: Vehicle listing program.

What follows is a little program I just wipped up to print out vehicle
descriptions reasonably nicely. I took a lot of the code straight from
the xtank source. I put it in the Util directory and compiled with 
cc -o vlist -I../Src vlist.c -lm
I am planning on making it output TeX as well so we can print out vehicles
in a nice format.
Usage is vlist [vehiclename ...]
No .v on the end of the names
